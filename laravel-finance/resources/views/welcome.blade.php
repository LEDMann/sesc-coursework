...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="h-screen bg-gray-200 dark:bg-gray-900 flex flex-col">
        <x-theme-toggle/>
        <a href="{{ route('invoice.migrate') }}" class="text-center w-min font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">Dashboard</a>
            ...
            <div class="max-w-7xl mx-auto p-6 lg:p-8">
                @if (Route::has('redirect'))
                    <div class="flex flex-col justify-center p-6 rounded-lg bg-gray-300 dark:bg-gray-800">
                        @auth
                            <div class="text-center text-xl p-6 text-gray-800 dark:text-gray-100">{{ __("Welcome to the Finance App!") }}</div>
